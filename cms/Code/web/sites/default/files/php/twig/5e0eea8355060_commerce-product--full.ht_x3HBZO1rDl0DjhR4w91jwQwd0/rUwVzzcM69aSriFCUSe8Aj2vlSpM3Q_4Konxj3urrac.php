...
/* themes/custom/christmas/templates/commerce/commerce-product--full.html.twig */
class __TwigTemplate_55a1c51e3b8eb79da4673a99077784b00d55f81730212f08b80c9718c053816b extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 24];
        $filters = ["escape" => 22, "clean_class" => 26, "without" => 40];
  ...
  <div class=\"row\">
    ...
    <div class=\"col-md-6\">
      <div class=\"commerce-product__contents\">";
        ...
        // line 40
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->withoutFilter($this->sandbox->ensureToStringAllowed(($context["product"] ?? null)), "field_images", "variation_attributes", "variation_price", "variation_field_images"), "html", null, true);
        // line 41
        echo "</div>
    </div>
  </div>
...
";
    ...
    {
        return "themes/custom/christmas/templates/commerce/commerce-product--full.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/christmas/templates/commerce/commerce-product--full.html.twig", "C:\\xampp\\htdocs\\demo-commerce\\web\\themes\\custom\\christmas\\templates\\commerce\\commerce-product--full.html.twig");
    }
}
