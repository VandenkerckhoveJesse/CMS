...
/* themes/custom/christmas/templates/menu/menu--social.html.twig */
class __TwigTemplate_f552f834fb24673cc3dd88dd129376d5f5de4e64693b07bd0900aead0dbab922 extends \Twig\Template
{
        ...
        try {
            ...
            if (($context["items"] ?? null)) {
                ...
                if ((($context["menu_level"] ?? null) == 0)) {
                    // line 30
                    echo "      <ul";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["attributes"] ?? null), "addClass", [0 => "menu", 1 => ("menu-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["menu_name"] ?? null)))), 2 => "list-unstyled"], "method")), "html", null, true);
                    echo ">
    ";
                } else {
                    // line 32
...
$context["item"], "title", [])))), 2 => "glyph__circled"];
      ...
      ";
        ...
        ";
                        // line 65
                        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->getLink($this->sandbox->ensureToStringAllowed(                        // line 67
...
$context["item"], "url", []))), "html", null, true);
  ...
  ";
    ...
    {
        return "themes/custom/christmas/templates/menu/menu--social.html.twig";
    }
    ...
    {
        return new Source("", "themes/custom/christmas/templates/menu/menu--social.html.twig", "C:\\xampp\\htdocs\\demo-commerce\\web\\themes\\custom\\christmas\\templates\\menu\\menu--social.html.twig");
    }
}
